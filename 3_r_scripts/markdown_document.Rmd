...
Figure A: Something like the following

![](lh_age_days_site.png)\

#### Question B: Does a mother's CORT and mass predict the percent aquatic in the diet of her nestlings?

When I was writing this question, I first wrote: In nestlings, do mass, CORT, or fledge success predict aquatic insect content in diet? However, it felt like it should be written the other way around: Does aquatic insect content predict mass, CORT, or fledge success. However, this conflicts with the plan of focusing on "what predicts aquatic insect content in the diet." Additionally, since the nestlings don't really have any control over their diets, I wonder if it's worth making this model adult-focused, as I've laid out below.

Model: Beta Logistic Regression: (percent aquatic (nest level) ~ mom's CORT + mom's mass)

CORT = probably baseline?

#### Question C: Does a female's CORT and mass predict the percent aquatic in her diet?

Model: Beta Logistic Regression: (percent aquatic ~ CORT + mass)
